...
steps = [
    ("MyDevelopment\\$ ", "telnet 172.25.27.3 2015", 5),
    ("\\]\\'.", "", 5),
    ("login:", "admin", 5),
    ("Password:", "Nbv12345", 5),
]
...
steps2 = [
    (r"\# ", "cd /mnt/emmc/hsu_intersight/hai && resize", 5),
    (r"\# ", "ps -lw | grep 'record_xfm' | awk '\\''{print $3}'\\'' | xargs -r kill -9", 5),
    (r"\# ", "nohup sh record_xfm.sh > xfm1.log &", 5),
    (r"\# ", "tail -F xfm1.log", 5),
]
# Execute steps
