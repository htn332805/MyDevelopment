...
steps = [
    ("MyDevelopment\\$ ", "telnet 172.25.27.3 2029", 5),    #CHANGE THE PORT HERE
    ("\\]\\'.", "", 5),
    ("login:", "admin", 5),
    ("Password:", "Nbv12345", 5),
]
...
pane_index = 9                                          #CHANGE THE TMUX PANE INDEX HERE
input_file = "../logs/BMC6.log"                         #CHANGE THE LOG NAME FOR THE PANE HERE
