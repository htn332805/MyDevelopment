...
expect "34972A>" {send ":Conf:Temp TC,T,(@101:107);:Unit:Temp C,(@101:107)\r"}
expect "34972A>" {send ":SENSe:TEMPerature:NPLC 2,(@101:107)\r"}
#expect  "34972A>" {send ":Format:Reading:Channel On\r"}
#expect  "34972A>" {send ":Format:Reading:Time On\r"}
expect "34972A>" {send ":SENSe:TEMPerature:APER 1, (@101:107)\r"}
...
expect "34972A>" {send ":Route:Scan (@101:107)\r"}
