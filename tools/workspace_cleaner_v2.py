...
from orchestrator.context.context import Context  # Imported for unified state management during cleanup
...
# Framework0 baseline components - ALWAYS PRESERVE during any cleaning operation
FRAMEWORK0_BASELINE = {
...
logger.info(f"Framework0 baseline components loaded: {len(FRAMEWORK0_BASELINE)} protected items")
