...
class SpacedRepetitionEngine:
    ...
    def __init__(
        ...
        self.selection_weights = (
            selection_weights or SelectionWeights()
        )  # Selection weights
    ...
    def process_question_attempt(
        ...
        try:
            ...
            if progress.average_time == 0:
                ...
                progress.average_time = (progress.average_time * 0.8) + (
            ...
            logger.debug(
                f"Question attempt processed: User {user_id}, Question {question_id}, "
    ...
    def _apply_sm2_algorithm(
        self, progress: QuestionProgress, performance_score: float
    ) -> QuestionProgress:
        ...
        if quality >= 3:
            ...
            progress.easiness_factor += 0.1 - (5 - quality) * (
                0.08 + (5 - quality) * 0.02
            )
        else:
        ...
        progress.next_review_date = date.today() + timedelta(
    ...
    def select_next_questions(
        ...
        try:
            ...
            candidate_questions = self._get_candidate_questions(
                user_id, preferred_hashtags, target_difficulty
            )
            ...
            for question_data in candidate_questions:
                score = self._calculate_selection_score(
                    question_data, preferred_hashtags, target_difficulty
                )
            ...
            logger.info(
                f"Selected {len(selected_questions)} questions for user {user_id}"
            )
    ...
    def _get_candidate_questions(
        ...
        """Get candidate questions for a user with optional filters."""
        try:
            ...
            for row in results:
                candidate = {
                    ...
                    or self.sm2_params.initial_easiness,
    ...
    def _filter_recent_questions(
        ...
        logger.debug(
            f"Anti-clustering filter: {len(candidates)} -> {len(filtered)} questions"
        )
        return filtered
    ...
    def _calculate_selection_score(
        ...
        """Calculate selection score for question prioritization."""
    ...
    def _update_recent_questions(self, question_ids: List[int]) -> None:
        ...
        """Update the list of recently shown questions for anti-clustering."""
        ...
        try:
            if question_ids:
                ...
                if len(self._recent_hashtags) > self._clustering_window * 3:
                    self._recent_hashtags = self._recent_hashtags[
                        -self._clustering_window * 3 :
                    ]
    ...
    def _get_question_progress(
        ...
        try:
            ...
            progress = QuestionProgress(
                ...
                next_review_date=(
                    datetime.strptime(row["next_review_date"], "%Y-%m-%d").date()
...
>>>>>>> 09358808f3e803617735c925d71ec563c5edd780
    def _save_question_progress(self, progress: QuestionProgress) -> None:
        ...
        """Save question progress data to database."""
        try:
            query = """
...
>>>>>>> 09358808f3e803617735c925d71ec563c5edd780
            ...
            current_streak = (
                streak_results[0]["current_streak"] if streak_results else 0
            )
...
<<<<<<< HEAD
            ...
            difficulty_results = self.database.execute_query(
                difficulty_query, (user_id,)
            )
=======
...
>>>>>>> 09358808f3e803617735c925d71ec563c5edd780
            ...
            statistics = {
                "user_id": user_id,
                "total_questions_attempted": stats_row.get(
...
<<<<<<< HEAD
def get_spaced_repetition_engine(
    database: Optional[QuizDatabase] = None,
